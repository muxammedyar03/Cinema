...
Window: `FOLLOW_NOTIFY_DEBOUNCE_MS` (default `300000`). Contract: [`docs/contracts/follow-notify.md`](../../docs/contracts/follow-notify.md#kan-35--per-cinema-digest-debounce).
